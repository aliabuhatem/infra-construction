          ...
          <div className="border-b border-white/5">
            ...
            >
              <div className="pb-3 pl-3 space-y-1">
                ...
                <Link href="/sectors/buildings" onClick={() => setOpen(false)} className="block text-white/90 hover:text-[#1F93A4] py-2 text-[12px] font-semibold uppercase tracking-wide transition-colors" style={{ fontFamily: B }}>
                  Buildings
                </Link>
                <div>
                  <Link href="/sectors/infrastructure" onClick={() => setOpen(false)} className="block text-white/90 hover:text-[#1F93A4] py-2 text-[12px] font-semibold uppercase tracking-wide transition-colors" style={{ fontFamily: B }}>
                    Infrastructure
                  </Link>
