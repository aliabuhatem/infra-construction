    ...
    <>
      ...
      <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14 pb-16 w-full text-shadow-legible">
          ...
          {heroDescription && (
            <p className="text-white/70 text-[13px] max-w-lg leading-relaxed mt-3" style={{ fontFamily: B }}>
              ...
              {features.map((f, i) => (
                <li key={i} className="border-b border-white/8 pb-5 last:border-0 last:pb-0 flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white/70 text-[12px] leading-relaxed" style={{ fontFamily: B }}>
      ...
      <section className="py-24 bg-[#0d1e28] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-14 gap-5">
            ...
            <p className="text-white/65 text-[13px] max-w-xs leading-relaxed hidden lg:block" style={{ fontFamily: B }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-[1px] bg-white/5">
            {serviceGroups.map((sg, i) => (
              ...
              >
                ...
                {sg.description && (
                  <p className="text-white/70 text-[12px] leading-relaxed mb-3" style={{ fontFamily: B }}>
                ...
                <ul className="space-y-2">
                  {sg.items.map((item, j) => (
                    <li
                      key={j}
                      className="flex items-start gap-2 text-[13px] text-white/70 group-hover:text-white/85 transition-colors"
                      style={{ fontFamily: B }}
                    >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-white/5">
            {whyUs.map((w, i) => (
              <div key={i} className="bg-[#213B4D] p-7 hover:bg-[#1a2f3d] transition-colors group">
                ...
                <p className="text-white/70 text-[12px] leading-relaxed" style={{ fontFamily: B }}>
