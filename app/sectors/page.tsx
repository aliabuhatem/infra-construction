...
const infraSubsectors = [
  {
    ...
    title: "Water",
    short: "Water supply systems, treatment plants, and integrated utility networks.",
  ...
  },
  {
    ...
    short: "Dam construction, dike works, and large-scale irrigation infrastructure.",
  ...
  },
  {
    ...
    title: "Ports",
    short: "Marine ports, quay walls, breakwaters, and harbour infrastructure.",
  ...
  },
  {
    ...
    slug: "infrastructure-civil-works",
    title: "Airports",
    short: "Airfield works, runways, terminal facilities, and aviation infrastructure.",
  ...
  },
  {
    ...
    short: "Highways, bridges, flyovers, and large-scale road networks.",
    image: "/media/infrastructure-coastal-highway-taiz-yemen.jpeg",
  },
  {
    num: "06",
    slug: "industrial-oil-services",
    title: "Oil",
    short: "Oil & gas pipelines, plant construction, and industrial O&M services.",
  ...
  },
  {
    ...
    slug: "energy-power",
    title: "Power",
    short: "Power generation, transmission networks, and substation infrastructure.",
...
const activityAreas = [
  ...
  { label: "Infrastructure & Civil Works",     href: "/sectors/infrastructure-civil-works" },
  { label: "Transportation, Roads & Bridges",  href: "/sectors/infrastructure-civil-works" },
  { label: "Ports & Marine",                   href: "/sectors/infrastructure-civil-works" },
  { label: "Airports",                          href: "/sectors/infrastructure-civil-works" },
  { label: "Water Supply & Networks",          href: "/sectors/water-utilities" },
  { label: "Dams & Irrigation",               href: "/sectors/water-utilities" },
  { label: "Wastewater Treatment",            href: "/sectors/water-utilities" },
  { label: "Power Generation",               href: "/sectors/energy-power" },
  { label: "Power Transmission",             href: "/sectors/energy-power" },
  { label: "Oil & Gas Pipelines",            href: "/sectors/industrial-oil-services" },
  { label: "Industrial Plant Construction",  href: "/sectors/industrial-oil-services" },
];
  ...
  return (
    <>
      ...
      <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
        <Image
          src="/media/sectors hero section photo.png"
          alt="Our Sectors"
          fill
  priority
  quality={100}
...
/>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14 pb-16 w-full">
          ...
          <p className="text-white/60 text-[17px] max-w-xl leading-relaxed" style={{ fontFamily: B }}>
            Two core sectors. One unified standard of delivery across every discipline and geography.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-14 grid lg:grid-cols-12 gap-14 items-end">
          <div className="lg:col-span-7">
            ...
            >
              Buildings & Infrastructure.<br />Built to Last.
            </h2>
            <p className="text-[#5E5E5E] text-[17px] leading-relaxed mt-6" style={{ fontFamily: B }}>
              INFRA Construction operates across two core sectors — Buildings and Infrastructure — bringing together multidisciplinary engineering expertise, strong project management, and proven operational capabilities to deliver world-class results across every discipline.
            </p>
          </div>
          <div className="lg:col-span-5 grid grid-cols-2 gap-[1px] bg-[#213B4D]/8">
            {[
              ...
              <div key={s.label} className="bg-white p-6">
                <div
                  className="text-[#213B4D] leading-none mb-1"
                  style={{ fontFamily: H, fontSize: "clamp(36px, 4vw, 52px)", fontWeight: 600 }}
                >
                  {s.value}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-6 h-[2px] bg-[#1F93A4] shrink-0" />
              <p className="text-[#1F93A4] text-[11px] font-bold uppercase tracking-[0.35em]" style={{ fontFamily: B }}>
                Sector 01 · Standalone
              </p>
            </div>
          </div>

          {/* Buildings card — full width */}
          <Link
            href="/sectors/buildings"
            className="group relative overflow-hidden block bg-[#0d1e28] hover:bg-[#1a3040] transition-colors"
          >
            <div className="relative h-[340px] lg:h-[420px] overflow-hidden">
              <Image
                src="/media/buildings-social-housing-assiut-egypt.avif"
                alt="Buildings"
                fill
              ...
              <div className="absolute inset-0 p-8 lg:p-12 flex flex-col justify-between lg:flex-row lg:items-end">
                <div className="flex-1">
                  ...
                  <h2
                    className="text-white uppercase leading-tight mb-3 group-hover:text-[#1F93A4] transition-colors"
                    style={{ fontFamily: H, fontSize: "clamp(32px, 5vw, 64px)", fontWeight: 600, letterSpacing: "-0.01em" }}
                  >
                    Buildings
                  </h2>
                  <p className="text-white/55 text-[15px] leading-relaxed max-w-lg" style={{ fontFamily: B }}>
                    Architectural design, MEP engineering, and construction of residential, commercial, and institutional buildings — from concept to handover.
                  </p>
                </div>
                <div className="mt-6 lg:mt-0 lg:ml-12 shrink-0">
                  <span className="text-[#1F93A4] text-[13px] font-bold uppercase tracking-[0.2em] flex items-center gap-2" style={{ fontFamily: B }}>
                    Explore Buildings <span className="group-hover:translate-x-1.5 transition-transform inline-block">→</span>
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-6 h-[2px] bg-[#1F93A4] shrink-0" />
              <p className="text-[#1F93A4] text-[11px] font-bold uppercase tracking-[0.35em]" style={{ fontFamily: B }}>
                Sector 02 · Infrastructure Umbrella
              </p>
            </div>
          </div>

          {/* Infrastructure parent card */}
          <Link
            href="/sectors/infrastructure"
            className="group relative overflow-hidden block bg-[#213B4D] hover:bg-[#1e3549] transition-colors mb-[1px]"
          >
            <div className="relative h-[200px] overflow-hidden">
              ...
              <div className="absolute inset-0 p-8 lg:p-10 flex items-center justify-between">
                <div>
                  <h2
                    className="text-white uppercase leading-tight mb-2 group-hover:text-[#1F93A4] transition-colors"
                  ...
                  <p className="text-white/50 text-[14px]" style={{ fontFamily: B }}>
                    Civil works · Water · Energy · Industrial — an integrated sector umbrella
                  </p>
                </div>
                <span className="text-[#1F93A4] text-[13px] font-bold uppercase tracking-[0.2em] flex items-center gap-2 shrink-0 ml-6" style={{ fontFamily: B }}>
                  Sector Overview <span className="group-hover:translate-x-1.5 transition-transform inline-block">→</span>
                </span>
              </div>
            </div>
          </Link>
            ...
            {infraSubsectors.map((s) => (
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  ...
                  <div
                    className="absolute top-4 left-4 text-[#1F93A4] leading-none"
                    style={{ fontFamily: H, fontSize: "28px", fontWeight: 600 }}
                  >
                    {s.num}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <h3
                    className="text-white font-bold text-[13px] mb-2 group-hover:text-[#1F93A4] transition-colors"
                    style={{ fontFamily: B }}
                  >
                    {s.title}
                  </h3>
          ...
          <div className="grid lg:grid-cols-12 gap-14 mb-14">
            <div className="lg:col-span-5">
              ...
              <p className="text-[#5E5E5E] text-[17px] leading-relaxed mt-5" style={{ fontFamily: B }}>
                Our capabilities span the full spectrum of buildings and infrastructure disciplines — from civil earthworks to complex construction programmes.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-[1px] bg-[#213B4D]/8">
            {activityAreas.map((area) => (
              <Link key={area.label} href={area.href} className="bg-white p-6 hover:bg-[#f4f6f8] transition-colors group block">
                <div className="w-5 h-[2px] bg-[#1F93A4] mb-4 group-hover:w-8 transition-all duration-300" />
                <span className="text-[#213B4D] text-[13px] font-semibold group-hover:text-[#1F93A4] transition-colors" style={{ fontFamily: B }}>{area.label}</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-28 bg-[#1F93A4] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-14 text-center">
          ...
          <p className="text-white/65 text-[17px] mb-10 max-w-lg mx-auto leading-relaxed" style={{ fontFamily: B }}>
            Our specialists are ready to discuss your requirements and tailor a solution for your specific needs.
          </p>
          <Link
            href="/contact"
