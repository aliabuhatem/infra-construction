  ...
  return (
    <>
      ...
      <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-[#0d1e28]/95 via-[#213B4D]/68 to-[#213B4D]/40" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          ...
          <Link href="/sectors/infrastructure" className="group relative overflow-hidden block bg-[#213B4D] hover:bg-[#1e3549] transition-colors mb-[1px]">
            <div className="relative h-[200px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#213B4D]/85 to-[#213B4D]/40" />
