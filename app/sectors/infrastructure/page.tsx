...
const subsectors = [
  {
    num: "01",
    title: "Water",
    short: "Water supply systems, treatment plants, and integrated utility networks built for longevity.",
    href: "/sectors/water-utilities",
    image: "/media/water-dam-construction-yemen.jpeg",
    disciplines: ["Water Supply Networks", "Wastewater Treatment", "Desalination", "Utility Networks"],
  },
  {
    num: "02",
    title: "Dams & Irrigation",
    short: "Dam construction, dike works, and large-scale irrigation infrastructure across arid regions.",
    href: "/sectors/water-utilities",
    image: "/media/water-hassan-dam-project-yemen.jpeg",
    disciplines: ["Dam Construction", "Dikes", "Irrigation Networks", "Flood Control"],
  },
  {
    num: "03",
    title: "Ports",
    short: "Marine ports, quay walls, breakwaters, and harbour infrastructure delivered to international standards.",
    href: "/sectors/infrastructure-civil-works",
    image: "/media/ports-hulaf-socotra-yemen.jpeg",
    disciplines: ["Quay Walls", "Breakwaters", "Marine Structures", "Port Master Planning"],
  },
  {
    num: "04",
    title: "Airports",
    short: "Airfield works, runways, terminal facilities, and aviation infrastructure for civil and strategic use.",
    href: "/sectors/infrastructure-civil-works",
    // FIXED: Using high-quality JPG instead of blurry PNG diagram
    image: "/media/airports-dhobab-airport-diagram.png",
    disciplines: ["Runways", "Airfield Works", "Terminal Facilities", "Aviation Infrastructure"],
  },
  {
    num: "05",
    title: "Transportation",
    short: "Highways, bridges, flyovers, and large-scale road networks delivered with proven civil engineering expertise.",
    href: "/sectors/infrastructure-civil-works",
    image: "/media/infrastructure-coastal-highway-taiz-yemen.jpeg",
    disciplines: ["Highways & Roads", "Bridges & Flyovers", "Causeways", "Road Rehabilitation"],
  },
  {
    num: "06",
    title: "Oil",
    short: "Oil & gas pipelines, plant construction, and comprehensive industrial operations support.",
    href: "/sectors/industrial-oil-services",
    image: "/media/industrial-floating-marine-pier-yemen.jpeg",
    disciplines: ["Oil & Gas Pipelines", "Plant Construction", "Industrial O&M", "Marine Pipelines"],
  },
  {
    num: "07",
    title: "Power",
    short: "Power generation, transmission networks, substations, and renewable energy infrastructure.",
    href: "/sectors/energy-power",
    image: "/media/energy-power-plant-alhaswa-aden-yemen.jpeg",
    disciplines: ["Power Plants", "Transmission Lines", "Substations", "Renewable Energy"],
  },
];
...
/>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14 pb-16 w-full">
          ...
          <p className="text-white/60 text-[15px] max-w-xl leading-relaxed" style={{ fontFamily: B }}>
            Civil works, water systems, energy, and industrial projects — delivered across the Middle East and Africa since 2000.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-14 grid lg:grid-cols-12 gap-14 items-start">
          <div className="lg:col-span-7">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-6 h-[2px] bg-[#1F93A4] shrink-0" />
              <p className="text-[#1F93A4] text-[11px] font-bold uppercase tracking-[0.35em]" style={{ fontFamily: B }}>Overview</p>
            </div>
            <h2
            ...
            <p className="text-[#5E5E5E] text-[15px] leading-relaxed" style={{ fontFamily: B }}>
              Operating across the Middle East and Africa since 2000, we bring proven technical expertise, ISO-certified quality management, and deep regional experience to every infrastructure engagement.
            </p>
          </div>
          <div className="lg:col-span-5 bg-[#0d1e28] p-8 self-start">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-5 h-[2px] bg-[#1F93A4]" />
              <span className="text-[#1F93A4] text-[11px] font-bold uppercase tracking-[0.35em]" style={{ fontFamily: B }}>Disciplines Covered</span>
            </div>
            <div className="space-y-0">
              {disciplines.map((d) => (
                <div key={d} className="flex items-center gap-2 text-white/55 text-[12px] py-2 border-b border-white/8 last:border-0" style={{ fontFamily: B }}>
      ...
      {/* SUBSECTORS — last card spans 2 cols so the row after Power is never empty */}
            ...
            {subsectors.map((s, i) => {
              ...
              return (
                <Link
                  key={s.num}
                  href={s.href}
                  className={`group relative overflow-hidden block bg-[#0d1e28] hover:bg-[#1a3040] transition-colors justify-self-center" ${
                     ""
                  }`}
                >
                  <div className={`relative ${isLast ? "h-72" : "h-56"} overflow-hidden`}>
                    ...
                    <div
                      className="absolute top-5 left-5 text-[#1F93A4] leading-none"
                      style={{ fontFamily: H, fontSize: "36px", fontWeight: 600 }}
                    >
                      {s.num}
                    </div>
                  </div>
                  <div className="p-7">
                    ...
                    <h3
                      className="text-white font-bold text-[15px] mb-3 group-hover:text-[#1F93A4] transition-colors"
                      style={{ fontFamily: B }}
                    >
                      {s.title}
                    </h3>
      ...
      <section className="relative py-28 bg-[#1F93A4] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-14 text-center">
          ...
          >
            Have an Infrastructure<br />Challenge?
          </h2>
          <p className="text-white/65 text-[15px] mb-10 max-w-lg mx-auto leading-relaxed" style={{ fontFamily: B }}>
            Our specialists are ready to discuss your requirements and design a tailored infrastructure solution for your specific needs.
          </p>
          <Link
            href="/contact"
