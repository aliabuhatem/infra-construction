  ...
  return (
    <>
      ...
      <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
        <Image src="/media/infrastructure-aden-causeway-widening-yemen.jpeg" alt="Infrastructure" fill priority quality={100} unoptimized sizes="100vw" className="object-cover object-center" />
