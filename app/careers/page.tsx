  ...
  return (
    <>
      ...
      <section className="relative h-[70vh] min-h-[540px] flex items-end overflow-hidden">
        <MediaImage category="careers_hero" title="backgroundImage" fallbackSrc="/media/careers hero section photo.webp" alt="Careers at INFRA" className="absolute inset-0 w-full h-full object-cover object-center" />
      ...
      <div className="bg-[#f6f8f9] border-b border-[#213B4D]/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-14 py-3 flex items-center gap-2 text-[11px] tracking-[0.15em] " style={{ fontFamily: B }}>
          ...
          <span className="text-[#1F93A4] font-semibold">Careers</span>
        </div>
      </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          <Reveal className="grid lg:grid-cols-2 gap-10 mb-16">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-6 h-[2px] bg-[#1F93A4] shrink-0" />
                <p className="text-[#F2613C] text-[11px] font-bold  tracking-[0.35em]" style={{ fontFamily: B }}>
              ...
              <h2 className="text-[#213B4D]  leading-tight" style={{ fontFamily: H, fontSize: "clamp(32px, 4.5vw, 56px)", fontWeight: 600, letterSpacing: "-0.01em" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {benefits.map((benefit, i) => (
              <div key={i} className="group relative overflow-hidden rounded-lg border border-[#213B4D]/10 p-8 hover:border-[#1F93A4] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 bg-white">
      ...
      {/* ── EMPOWERING TALENT ───────────────────────────────────────────── */}
      <section className="bg-[#f6f8f9] overflow-hidden border-y border-[#213B4D]/8">
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          <div className="grid lg:grid-cols-2 gap-[1px] items-stretch">
            ...
            <Reveal direction="left" className="py-20 px-10 lg:px-16 flex flex-col justify-center">
              ...
              <h2 className="text-[#213B4D]  leading-tight mb-6" style={{ fontFamily: H, fontSize: "clamp(28px, 3.5vw, 48px)", fontWeight: 600, letterSpacing: "-0.01em" }}>
                <ContentText section="careers_empower" name="title" fallback="Empowering Talent Across Borders" />
              </h2>
              <p className="text-[#5E5E5E] text-[16px] leading-relaxed mb-4" style={{ fontFamily: B }}>
              ...
              <p className="text-[#5E5E5E] text-[16px] leading-relaxed mb-8" style={{ fontFamily: B }}>
              ...
              <div className="grid grid-cols-2 gap-[1px] bg-[#213B4D]/8">
                {["Engineers", "Project Managers", "Technicians", "Consultants", "Inspectors", "Specialists"].map((role) => (
                  <div key={role} className="bg-white px-4 py-3 flex items-center gap-2 hover:bg-[#eef1f3] transition-colors group">
                    <span className="text-[#1F93A4] text-[10px]">▸</span>
                    <span className="text-[#213B4D]/85 text-[13px] group-hover:text-[#1F93A4] transition-colors" style={{ fontFamily: B }}>{role}</span>
                  </div>
                ))}
              </div>
            </Reveal>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-14">
          <Reveal className="grid lg:grid-cols-12 gap-14 mb-14">
            <div className="lg:col-span-7">
              ...
              <h2 className="text-[#213B4D]  leading-tight" style={{ fontFamily: H, fontSize: "clamp(20px, 4vw, 52px)", fontWeight: 600, letterSpacing: "-0.01em" }}>
              ...
              <div key={i} className="bg-white hover:bg-[#f4f6f8] transition-colors px-8 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 group">
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2" style={{ fontFamily: B }}>
                    ...
                    <span className="border border-[#213B4D]/20 text-[#213B4D] text-[10px] font-bold  tracking-wider px-2.5 py-1">
                      <ContentText section={job._key} name="type" fallback={job.type || ""} />
                    </span>
                  </div>
                </div>
                <Link href="/contact" className="shrink-0 border border-[#213B4D] text-[#213B4D] font-bold text-[12px]  tracking-widest px-6 py-3 hover:bg-[#213B4D] hover:text-white transition-all duration-300" style={{ fontFamily: B }}>
                  Apply Now
                </Link>
              </div>
            ))}
      ...
      <section className="relative py-28 bg-[#1F93A4] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-14 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-3 bg-white text-[#213B4D] font-bold px-10 py-4 text-[13px]  tracking-widest hover:bg-[#213B4D] hover:text-white transition-all duration-300" style={{ fontFamily: B }}>
