...
const projects = [
  ...
  { title: "Floating Marine Pier",                    country: "Yemen",       sector: "Infrastructure & Civil Works",type: "Marine Works",         description: "Procurement and construction of a floating marine pier — structural works, mooring systems, and marine access.",     image: "/media/ports-floating-marine-pier-yemen.jpeg",              sectionKey: "project_17" },
  { title: "Aden Port Master Plan Study",             country: "Yemen",       sector: "Infrastructure & Civil Works",type: "Marine Works",         description: "Port traffic study and master plan for Aden — comprehensive analysis of port capacity and infrastructure.",          image: "/media/ports-aden-master-plan-port-study.png",              sectionKey: "project_3" },
  ...
  { title: "Marine Breakwater Works",                 country: "Yemen",       sector: "Infrastructure & Civil Works",type: "Marine Works",         description: "Coastal protection and marine breakwater construction providing critical wave attenuation and harbour protection.",   image: "/media/ports-marine-breakwater-yemen.jpeg",                 sectionKey: "project_4" },
  { title: "Basra Wastewater Treatment Plant",        country: "Egypt",       sector: "Water & Utilities",           type: "Wastewater",           description: "Labour and material supply for Basra Wastewater Treatment Plant — civil works and infrastructure for plant operations.", image: "/media/water-basra-wastewater-treatment-egypt.jpeg",        sectionKey: "project_11" },
  ...
  return (
    <>
      ...
      <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
        <Image src="/media/project-hero.jpg" alt="Our Projects" fill priority quality={100} unoptimized sizes="100vw" className="object-cover object-center" />
